...
def main():
    ...
    print("final_output_dir is :", final_output_dir)
    ...
    # build model
    print('models.' + config.MODEL.NAME + '.get_seg_model')
    ...
    for epoch in range(last_epoch, end_epoch):
        ...
        if args.local_rank == 0:
            ...
            }, os.path.join(final_output_dir, 'epoch.pth.tar'))
            # torch.save(model.state_dict(), os.path.join(final_output_dir, f'CP_epoch{epoch + 1}.pth'))
