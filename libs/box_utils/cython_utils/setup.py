...
ext_modules = [
    ...
    #     sources=["I:/project_insulator/code/FPN_Tensorflow-master/libs/box_utils\cython_utils/bbox.pyx"],
    #     # define_macros={'/LD'},
    ...
    #     sources=["I:/project_insulator/code/FPN_Tensorflow-master/libs/box_utils/cython_utils/nms.pyx"],
    #     extra_compile_args={'cl': []},
    #     include_dirs=[numpy_include],
    # ),
    # Extension(
