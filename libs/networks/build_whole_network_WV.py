...
class DetectionNetwork(object):
    ...
    def build_fastrcnn(self, P_list, rois_list, img_shape):
        ...
        with tf.variable_scope('Fast-RCNN'):
            ...
            with tf.variable_scope('rois_pooling'):
                ...
                pooled_features = tf.concat(pooled_features_list, axis=0) # [minibatch_size, H, W, C] 每个batch_size 高 宽 通道数
    ...
    def get_restorer(self):
        ...
        checkpoint_path = os.path.join(cfgs.TRAINED_CKPT, cfgs.VERSION_WV)
